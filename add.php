    ...
    <div class="panel-heading">
        ...
        <form action="add.php" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="local" placeholder="Enter 4 Digit Local No." pattern="\d{4}" maxlength="4" title="#### Eg: 1234" id="local" class="form-control"> 
            </div>
            <!-- Cell -->
            <div class="mb-3">
                <label for="cell">Cell</label>
                <input type="text" name="cell" placeholder="Enter 10 Digit Cell No. ###-###-####" pattern="\d{3}-\d{3}-\d{4}" maxlength="12" title="###-###-#### Eg: 123-456-7890" id="cell" class="form-control"> 
            </div>
            <!-- Status -->
            <div class="mb-3">
