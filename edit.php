    ...
    <div class="panel-heading">
        ...
        <form action="edit.php" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="local" placeholder="Enter 4 Digit Local No." pattern="\d{4}" maxlength="4" title="#### Eg: 1234" id="local" class="form-control" value="<?php echo $fetchedLocal; ?>"> 
            </div>
            <!-- Cell -->
            <div class="mb-3">
                <label for="cell">Cell</label>
                <input type="tel" name="cell" placeholder="Enter 10 Digit Cell No. ###-###-####" pattern="\d{3}-\d{3}-\d{4}" maxlength="12" title="###-###-#### Eg: 123-456-7890" id="cell" class="form-control" value="<?php echo $fetchedCell; ?>"> 
            </div>
            <!-- Status -->
            <div class="mb-3 ">
            ...
            <div class="mb-3">
                ...
                <select name="team[]" id="team" class="selectpicker"  data-width="300px" data-style="btn-primary" multiple="multiple" required>
                    ...
                    <option value="Administration" 
                        <?php 
                        if(strpos($fetchedTeam,"Administration") === true) echo 'selected="selected"'; 
                        ?>>
                        Administration
                    </option>
                    <!-- App Services -->
                    <option value="App Services" 
                        <?php 
                        if(strpos($fetchedTeam,"App Services") === true) echo 'selected="selected"'; 
                        ?>>
                        App Services
                    </option>
                    <!-- AV Integration -->
                    <option value="AV Integration" 
                        <?php 
                        if(strpos($fetchedTeam,"AV Integration") === true) echo 'selected="selected"'; 
                        ?>>
                        AV Integration
                    </option>
                    <!-- AV Production -->
                    <option value="AV Production" 
                        <?php 
                        if(strpos($fetchedTeam,"AV Production") === true) echo 'selected="selected"'; 
                        ?>>
                        AV Production
                    </option>
                    <!-- Desktop - Anvil -->
                    <option value="Desktop - Anvil" 
                        <?php 
                        if(strpos($fetchedTeam,"Desktop - Anvil") === true) echo 'selected="selected"'; 
                        ?>>
                        Desktop - Anvil
                    </option>
                    <!-- Desktop - NW -->
                    <option value="Desktop - NW" 
                        <?php 
                        if(strpos($fetchedTeam,"Desktop - NW") === true) echo 'selected="selected"'; 
                        ?>>
                        Desktop - NW
                    </option>
                    <!-- Desktop - DL -->
                    <option value="Desktop - DL" 
                        <?php 
                        if(strpos($fetchedTeam,"Desktop - DL") === true) echo 'selected="selected"'; 
                        ?>>
                        Desktop - DL
                    </option>
                    <!-- Desktop - TTG -->
                    <option value="Desktop - TTG" 
                        <?php 
                        if(strpos($fetchedTeam,"Desktop - TTG") === true) echo 'selected="selected"'; 
                        ?>>
                        Desktop - TTG
                    </option>
                    <!-- Endpoint -->
                    <option value="Endpoint" 
                        <?php 
                        if(strpos($fetchedTeam,"Endpoint") === true) echo 'selected="selected"'; 
                        ?>>
                        Endpoint
                    </option>
                    ...
                    <option value="IS - Communications & Id Management" 
                        <?php 
                        if(strpos($fetchedTeam,"IS - Communications & Id Management") === true) echo 'selected="selected"'; 
                        ?>>
                        IS - Communications & Id Management
                    </option>
                    <!-- IS - Data Centre -->
                    <option value="IS - Data Centre" 
                        <?php 
                        if(strpos($fetchedTeam,"IS - Data Centre") === true) echo 'selected="selected"'; 
                        ?>>
                        IS - Data Centre
                    </option>
                    <!-- IS - Physical Network -->
                    <option value="IS - Physical Network" 
                        <?php 
                        if(strpos($fetchedTeam,"IS - Physical Network") === true) echo 'selected="selected"'; 
                        ?>>
                        IS - Physical Network
                    </option>
                    <!-- Learning Designers -->
                    <option value="Learning Designers" 
                        <?php 
                        if(strpos($fetchedTeam,"Learning Designers") === true) echo 'selected="selected"'; 
                        ?>>
                        Learning Designers
                    </option>
                    <!-- LMS -->
                    <option value="LMS" 
                        <?php 
                        if(strpos($fetchedTeam,"LMS") === true) echo 'selected="selected"'; 
                        ?>>
                        LMS
                    </option>
                    <!-- Security -->
                    <option value="Security" 
                        <?php 
                        if(strpos($fetchedTeam,"Security") === true) echo 'selected="selected"'; 
                        ?>>
                        Security
                    </option>
                    <!-- Service Desk -->
                    <option value="Service Desk" 
                        <?php 
                        if(strpos($fetchedTeam,"Service Desk") ===true) echo 'selected="selected"'; 
                        ?>>
                        Service Desk
                    </option>
                    <!-- VConf -->
                    <option value="VConf" 
                        <?php 
                        if(strpos($fetchedTeam,"VConf") === true) echo 'selected="selected"'; 
                        ?>>
                        VConf
                    </option>
                    ...
                    <option value="Projects and Business Solutions" 
                        <?php 
                        if(strpos($fetchedTeam,"Projects and Business Solutions") === true) echo 'selected="selected"'; 
                        ?>>
                        Projects and Business Solutions
                    </option>
                </select>
